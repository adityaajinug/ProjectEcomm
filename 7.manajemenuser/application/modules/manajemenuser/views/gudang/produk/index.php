          ...
          <tbody>
            ...
            ?>
              <tr>
                ...
                <td>
                  <a href="<?= base_url('barang/edit_barang/' . $b['id']); ?>" class="btn btn-success btn-circle">
                    <i class="fas fa-edit"></i>
                  </a>
                  <a href="<?= base_url('barang/hapus_barang/' . $b['id']); ?>" class="btn btn-danger btn-circle button-hapus">
